...
#=====================================
# Author      : Zhaoyoubiao
# File name   : train_lstm_crf.py
# Create date : 2020/12/31 17:03
# IDE         : pycharm
#=====================================
import logging
...
# set logging
log_file_path = "./lstm_crf_ckpt/run.log"
...
data_processor_train = DataProcessor(
    ...
    os.path.join(base_dir, "train_bio.txt"),
    w2i_char,
    w2i_bio,
    shuffling=True
)
...
data_processor_valid = DataProcessor(
    ...
    os.path.join(base_dir, "test_bio.txt"),
    w2i_char,
    w2i_bio,
    shuffling=True
)
...
with tf.Session(config=tf_config) as sess:
    ...
    while epoches < 20:
        ...
        if batches % 100 == 0:
            ...
            ckpt_save_path = "./models/address.model.ckpt.batch{}".format(batches)
