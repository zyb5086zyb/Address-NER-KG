...
#=====================================
# Author      : Zhaoyoubiao
# File name   : model_lstm_crf.py
# Create date : 2020/12/31 17:06
# IDE         : pycharm
#=====================================
...
class MyModel(object):
    ...
    # MyModel(embedding_dim=300， hidden_dim=300, vocab_size_char=len(w2i_char), vocab_size_bio=len(w2i_bio), use_crf=True)
    def __init__(self,
                 embedding_dim,
                 hidden_dim,
                 vocab_size_char,
        ...
        with tf.variable_scope('loss'):
            if not use_crf:
                loss = tf.nn.sparse_softmax_cross_entropy_with_logits(logits=logits_seq,
