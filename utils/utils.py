...
class DataProcessor_MTL_LSTM_WLF(object):
    def __init__(self,
        ...
        assert all(len(input_seq_char) == len(input_seq_word) for input_seq_char, input_seq_word in
                   zip(inputs_seq_char, inputs_seq_word))
        assert len(inputs_seq_char) == len(outputs_seq_bio)
        assert all(len(input_seq_char) == len(output_seq_bio) for input_seq_char, output_seq_bio in
                   zip(inputs_seq_char, outputs_seq_bio))
        assert len(inputs_seq_char) == len(outputs_seq_attr)
        assert all(len(input_seq_char) == len(output_seq_attr) for input_seq_char, output_seq_attr in
                   zip(inputs_seq_char, outputs_seq_attr))
...
def extract_kvpairs_in_bio(bio_seq, word_seq):
    # O O O O O O B I I E B I I I I I I I I I I E O O O O O O B E
...
if __name__ == '__main__':
    bio_seq = "B I I E B I I I I I I I I I I E O O O O O O B E"
    word_seq = "B I I E B I I I I I I I I I I E O O O O O O B E"
    bio_seq = bio_seq.split(" ")
    word_seq = word_seq.split(" ")
    extract_kvpairs_in_bio(bio_seq, word_seq)
